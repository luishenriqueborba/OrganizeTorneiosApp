...
public class JogadorArtilhariaListAdapter extends ArrayAdapter<Jogador> implements View.OnClickListener {
    ...
    private static class ViewHolder {
        ...
        TextView txtQtdGols;
        ImageView imgAvatar;
        ImageView imgAdicionarGols;
        ImageView imgRemoverGols;
        ImageView imgDeletarJogador;

    }


    public JogadorArtilhariaListAdapter(ArrayList<Jogador> dataSet, Context context) {
    ...
    public View getView(int position, View dataSet, @NonNull ViewGroup parent) {
        ...
        if (dataSet == null) {
            ...
            linha = new JogadorArtilhariaListAdapter.ViewHolder();
            ...
            linha = (JogadorArtilhariaListAdapter.ViewHolder) dataSet.getTag();
        }
